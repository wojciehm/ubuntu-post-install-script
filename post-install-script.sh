...
sudo apt install -y git ansible git-all curl zsh net-tools sysstat vnstat iotop iftop bwm-ng htop lolcat figlet ntpdate ca-certificates gnupg lsb-release ntp zip unzip gnupg apt-transport-https ca-certificates net-tools ncdu apache2-utils
git version
